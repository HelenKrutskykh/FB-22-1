// Morse
// You have to write a simple Morse code decoder. While the Morse code is now mostly 
// superceded by voice and digital data communication channels, it still has its use 
...
//  return a decoded human-readable string. Good luck!
...
const decodedOne = decodeMorse(".... . -.-- .--- ..- -.. .");//heyjude
const decodedTwo = decodeMorse("... .-.. .- ...- .- ..- -.- .-. .- .. -. . ");//slavaukraine  
const decodedThree = decodeMorse(". ...- . .-. -.-- - .... .. -. --. .-- .. .-.. .-.. -... . ..-. .. -. . ");//everythingwillbefine

console.log(decodedOne);
console.log(decodedTwo);
console.log(decodedThree);